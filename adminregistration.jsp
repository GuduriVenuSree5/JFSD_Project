...
<head>
    ...
    <style>
        ...
        .card {
            ...
            padding: 30px;
            background-color: rgba(184, 184, 184, 1); /* Translucent background */
        }
        .form-group {
        ...
        .btn-primary {
            background-color:  #737373; /* Purple button */
            border-color: #D0E8E6;
            color: white;
...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="text-center mt-3">
                <p>Already have an account? <a href="adminlogin" class="text-light">Login</a></p>
            </div>
        </div>
    </div>
    ...
    <script>
        function validateForm() {
            ...
            if (id === '' || firstname === '' || lastname === '' || email === '' || password === '' || contactnumber === '') {
